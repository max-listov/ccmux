...
второй после busy timeout (1 с) отвечает из последнего закоммиченного индекса — он верен до своего
offset и описывается как частично продвинутый (`indexedBytes < sourceBytes`), а не как отказ.
