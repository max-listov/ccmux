...
import { parseOpts, lastAssistantText } from "../src/commands/transcript.ts";
...
const msg = (over: Partial<TranscriptMessage>): TranscriptMessage => ({
  id: "1", seq: 1, createdAt: null, role: "assistant", kind: "message", text: "hi", title: null,
  toolName: null, toolCallId: null, status: null, rawType: null, done: false, result: null,
  input: null, resultText: null, ...over,
});
