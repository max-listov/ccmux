...
try {
  ...
  check(first.target === undefined && first.source.kind === "host", "Host catalog invented a target");
  ...
  const safeKeys = ["id", "model", "displayName", "description", "hidden", "isDefault", "inputModalities",
