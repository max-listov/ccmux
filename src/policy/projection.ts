...
export function projectApplicationPolicy(metadata: ApplicationPolicyMetadata, availability: string,
  native?: ApplicationPolicyEvidence): ApplicationPolicyEvidence {
