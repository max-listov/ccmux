 ...
 * costs ~39 ms to evaluate, and `session/status.ts` — which imports zod, the agent barrel, chat
 ...
 * dependency evaluated thirty times a minute to check six fields. `session/status.ts` re-exports
