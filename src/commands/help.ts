...
export const COMMANDS: HelpEntry[] = [
  ...
  {
    verb: 'new',
    args: '<name> <dir> [--agent claude|codex|opencode] [--runtime tui|app-server|native] [-- flags]',
  ...
  {
    verb: 'chat',
    args: '<log [-n N] [--fleet] [--json] | on <name|machine:name> | off <name|machine:name>>',
  ...
  {
    verb: 'transcript',
    args: '<name|machine:name|app/UUID|machine:app/UUID|external:provider:machine#UUID> <--json [--tail N] [--cursor LINE] [--before LINE --limit N] | --last-message>',
  ...
  {
    verb: 'install',
    args: '[--rc-prefix <name>] [--release-url URL]',
