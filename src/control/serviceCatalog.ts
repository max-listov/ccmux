...
export const CCMUX_CONTROL_SERVICE_REVISION = "2";
export const CCMUX_CONTROL_SERVICE_BASE_URL = "https://ccmux.invalid";
export const CCMUX_CONTROL_SERVICE_PREFIX = "/ccmux/control/2";
export const CCMUX_CONTROL_SERVICE_INGRESS_PATH = "/ccmux-control/v2/invoke";
...
export const ControlServiceOperationSchema = z.enum([
  "history.read", "context.compact", "context.operation", "session.fork", "turn.steer", "turn.steering-operation",
  "selection.read", "selection.update",
  "attachment.begin", "attachment.chunk", "attachment.finalize", "attachment.cancel", "attachment.read",
  "runtime.list",
  "session.get",
  "session.create",
  "session.archive",
...
export const ControlServiceEffectSchema = z.enum([
  "history.read", "context.write", "context.read", "session.fork", "turn.steer", "turn.steering.read",
  "selection.read", "selection.write", "attachment.write", "attachment.read",
  "runtime.read",
  "session.read",
  "session.create",
  "session.archive",
...
export const controlServiceEffects = {
  "history.read": "history.read", "context.compact": "context.write", "context.operation": "context.read",
  "session.fork": "session.fork", "turn.steer": "turn.steer", "turn.steering-operation": "turn.steering.read",
  "selection.read": "selection.read", "selection.update": "selection.write",
  "attachment.begin": "attachment.write", "attachment.chunk": "attachment.write",
  "attachment.finalize": "attachment.write", "attachment.cancel": "attachment.write", "attachment.read": "attachment.read",
...
export const controlServiceInputs = {
  "history.read": ControlHistoryReadSchema, "context.compact": ControlCompactSchema,
  "context.operation": ControlContextOperationReadSchema, "session.fork": NativeForkRequestSchema,
  "turn.steer": SteeringInputSchema, "turn.steering-operation": SteeringSelectorSchema,
  "selection.read": SelectionReadSchema, "selection.update": SelectionUpdateSchema,
  "attachment.begin": AttachmentBeginSchema, "attachment.chunk": AttachmentChunkSchema,
  "attachment.finalize": AttachmentUploadSelectorSchema, "attachment.cancel": AttachmentUploadSelectorSchema,
...
export const controlServiceOutputs = {
  "history.read": ControlHistoryResultSchema, "context.compact": ControlContextOperationResultSchema,
  "context.operation": ControlContextOperationResultSchema, "session.fork": ControlCreateReceiptSchema,
  "turn.steer": SteeringReceiptSchema, "turn.steering-operation": SteeringReadResultSchema,
  "selection.read": SelectionResultSchema, "selection.update": SelectionResultSchema,
  "attachment.begin": AttachmentUploadReceiptSchema, "attachment.chunk": AttachmentUploadReceiptSchema,
  "attachment.finalize": AttachmentReferenceSchema, "attachment.cancel": AttachmentCancelReceiptSchema,
