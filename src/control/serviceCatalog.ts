...
export const controlServiceEffects = {
  ...
  'permission.update': 'permission.write',
...
export const controlServiceInputs = {
  ...
  'message.cancel': ControlMessageCancelSchema,
  'history.read': ControlHistoryReadSchema,
  'transcript.read': ControlTranscriptReadSchema,
  ...
  'permission.read': ControlPermissionReadSchema,
  'permission.update': ControlPermissionUpdateSchema,
...
export const controlServiceOutputs = {
  ...
  'message.cancel': ControlMessageCancelReceiptSchema,
  'history.read': ControlHistoryResultSchema,
  'transcript.read': ControlTranscriptResultSchema,
  ...
  'permission.read': ControlPermissionResultSchema,
  'permission.update': ControlPermissionResultSchema,
