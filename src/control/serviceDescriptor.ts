...
import { CCMUX_CONTROL_SERVICE_ID, CCMUX_CONTROL_SERVICE_REVISION, CCMUX_CONTROL_SERVICE_BASE_URL,
  CCMUX_CONTROL_SERVICE_PREFIX, CCMUX_CONTROL_SERVICE_MAX_REQUEST_BYTES, CCMUX_CONTROL_SERVICE_MAX_RESPONSE_BYTES,
  ControlServiceOperationSchema, ControlServiceEffectSchema, controlServiceEffects, type ControlServiceOperation } from "./serviceCatalog.ts";

export * from "./serviceCatalog.ts";
export { ccmuxControlServiceContract, createCcmuxControlServiceClient, ApiError, type ClientFetch } from "./serviceClient.ts";
...
export const ccmuxControlServiceDescriptor = ControlServiceDescriptorSchema.parse({
  ...
  maxInflight: 8,
  operations: [
    { id: "history.read", effect: controlServiceEffects["history.read"], limits: { requestBytes: 16 * 1024, responseBytes: 384 * 1024, timeoutMs: 7000 } },
    { id: "context.compact", effect: controlServiceEffects["context.compact"], limits: { requestBytes: 8192, responseBytes: 8192, timeoutMs: 5000 } },
    { id: "context.operation", effect: controlServiceEffects["context.operation"], limits: { requestBytes: 8192, responseBytes: 8192, timeoutMs: 5000 } },
    { id: "session.fork", effect: controlServiceEffects["session.fork"], limits: { requestBytes: 8192, responseBytes: 16 * 1024, timeoutMs: 30_000 } },
    { id: "turn.steer", effect: controlServiceEffects["turn.steer"], limits: { requestBytes: 32 * 1024, responseBytes: 8192, timeoutMs: 15_000 } },
    { id: "turn.steering-operation", effect: controlServiceEffects["turn.steering-operation"], limits: { requestBytes: 8192, responseBytes: 8192, timeoutMs: 5000 } },
    { id: "selection.read", effect: controlServiceEffects["selection.read"], limits: { requestBytes: 8192, responseBytes: 16 * 1024, timeoutMs: 5000 } },
    { id: "selection.update", effect: controlServiceEffects["selection.update"], limits: { requestBytes: 16 * 1024, responseBytes: 16 * 1024, timeoutMs: 10_000 } },
    { id: "attachment.begin", effect: controlServiceEffects["attachment.begin"], limits: { requestBytes: 8192, responseBytes: 4096, timeoutMs: 10_000 } },
    { id: "attachment.chunk", effect: controlServiceEffects["attachment.chunk"], limits: { requestBytes: 36 * 1024, responseBytes: 4096, timeoutMs: 10_000 } },
    { id: "attachment.finalize", effect: controlServiceEffects["attachment.finalize"], limits: { requestBytes: 8192, responseBytes: 4096, timeoutMs: 15_000 } },
    { id: "attachment.cancel", effect: controlServiceEffects["attachment.cancel"], limits: { requestBytes: 8192, responseBytes: 4096, timeoutMs: 10_000 } },
    { id: "attachment.read", effect: controlServiceEffects["attachment.read"], limits: { requestBytes: 8192, responseBytes: 36 * 1024, timeoutMs: 5000 } },
